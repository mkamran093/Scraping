from scrape import scrape_with_proxy_rotation
from constants import proxies

categories_url = {"1": "https://www.wayfair.co.uk/furniture/cat/furniture-c1852173.html", 
...
def main():
    ...
    scrape_with_proxy_rotation(url, proxies)
